...
//take elements from one array, and inseret them into another
//while iterating over that array

//while arr right !== 0
//pop an element off right array
//iterate over left array
//if poped value <= current left index value
// left.splice(i,0,val)
...
var mergeSort = function(array) {
  ...
  var leftArr = array.splice(half);

  array = mergeSort(array);
  leftArr = mergeSort(leftArr);


  return merge(array, leftArr);
};
 ...
 // Your code here.
  //find half the length of array (favor the floor)
  //split the array,
  //run mergesort on left (smaller0)
  //run mersort on the right (larger)
  //run merge on both
  //return array
